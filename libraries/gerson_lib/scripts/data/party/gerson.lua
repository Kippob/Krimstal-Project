...
function character:init()
    ...
    -- Display name
    self.name = (Kristal.getLibConfig("gersonlib", "gerson_name") and "Gerson") or "Old Man"
	...
	self.name_sprite = (Kristal.getLibConfig("gersonlib", "gerson_name") and "party/gerson/name") or "party/gerson/name_old"
end
