...
function spell:init()
    ...
    -- Display name
    self.name = (Kristal.getLibConfig("gersonlib", "green_buster_name") and "Green Buster") or "Old Buster"
    -- Name displayed when cast (optional)
    self.cast_name = nil

    -- Battle description
    self.effect = (Kristal.getLibConfig("gersonlib", "green_buster_name") and "Green\ndamage") or "Old\ndamage"
    -- Menu description
