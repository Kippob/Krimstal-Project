---@class StarBeam : Sprite
---@overload fun(...) : StarBeam
local StarBeam, super = Class(Sprite)

function StarBeam:init(red, x, y, tx, ty, after)
    ...
    self.target_x = tx
    self.target_y = ty
    self.rotation = Utils.angle(x, y, tx, ty) + math.rad(135)
